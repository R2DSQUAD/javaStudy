...
public class DCar extends CarBasic{
	...
	public DCar(String carName, int carWeigth, int carParice, int carYear) {
		super();
	...
	@Override
	public void carInfo() {
		System.out.println("D자동차 입니다.");
	}

	@Override
	public String toString() {
		return "DCar [carName=" + carName + ", carWeigth=" + carWeigth + ", carParice=" + carParice + ", carYear="
				+ carYear + "]";
	}
}
